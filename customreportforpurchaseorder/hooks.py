...
fixtures = [
	...
	{
	"doctype": "Pre Purchase Order",

            "filters": { "owner" : ["=", "Administrator"] }
	},
	{
	"doctype": "Pre Purchase Order Item",
            "filters": { "parenttype" : ["=", "Pre Purchase Order"] }
	},
...
#app_include_js = "/erpnext/buying/report/items_to_be_requested_from_stock_requistion/                 items_to_be_requested_from_stock_requistion.js"	
